                  ...
                  if (timeUp2sec) {                                            // update drive state after 2 seconds
                     ...
                     switch(driveIndex) {                                      // cycle through drive states
                        ...
                        case 1:// Rotate 90 degrees CW
                          ...
                          if (LeftEncoder.lRawEncoderCount >= -10000){ // (-10000+150)= -9850 <+- 150 is 90 degrees>
                        ...
                        case 3:// Rotate 90 degrees CW
                          ...
                          Bot.Right("D1", leftDriveSpeed, rightDriveSpeed);
                          if (LeftEncoder.lRawEncoderCount >= -10850){ // (-10850+150)= -10700 
                        ...
                        case 4:  //drive forward 100cm again 
                          ...
                          Bot.Forward("D1", leftDriveSpeed, rightDriveSpeed);   //drive ID, left speed, right speed
                          if (LeftEncoder.lRawEncoderCount <= -20850){       //-10700-10000 ,stop when 100 cm is reached
                        ...
                        case 5:// Rotate 90 degrees CCW
                          ...
                          if (LeftEncoder.lRawEncoderCount <= -21150 ){ // -20700-150= -20850 
                            Serial.print("case 5 end");
                            delay(1000);
                            driveIndex = 6; //go to case 6
                          }
                            break;
                        ...
                        case 7:// Rotate 90 degrees CCW
                          ...
                          Bot.Left("D1", leftDriveSpeed, rightDriveSpeed);
                          if (LeftEncoder.lRawEncoderCount <= -22150 ){ // -21850-150= -22000
                            Serial.print("case 7 end");
                            delay(1000);
                            LeftEncoder.lRawEncoderCount = 0;
                            RightEncoder.lRawEncoderCount = 0;
                            driveIndex = 0; //go to case 0
                             ++ rotationCounter;
                            Serial.println(rotationCounter);
                            
                             if (rotationCounter >= 5) { // Check if 10 rotations have been completed
